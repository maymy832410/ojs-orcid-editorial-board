...
class EditorialBoardConsentRequest extends Mailable
{
    use Configurable;

    protected static ?string $name = 'plugins.generic.orcidEditorialBoard.consentRequest.name';
    protected static ?string $description = 'plugins.generic.orcidEditorialBoard.consentRequest.description';
    protected static ?string $emailTemplateKey = 'EDITORIAL_BOARD_ORCID_CONSENT';

    public function __construct(Journal $context, EditorialBoardMember $member, string $consentUrl)
    {
    ...
    public static function getDataDescriptions(): array
    {
        return array_merge(parent::getDataDescriptions(), [
            'consentUrl' => __('emailTemplate.variable.orcid.consentUrl'),
